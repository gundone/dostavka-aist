<?php
wp_enqueue_script("tariff", "/wp-content/plugins/aist-dostavka/tariff.js", array(), mktime(0,0,0,  date("n"), date("j"), date("Y")));
wp_enqueue_script("autocomplete", "/wp-content/plugins/aist-dostavka/autocomplete/auto-complete.js");
wp_enqueue_script("dostavka-calc", "/wp-content/plugins/aist-dostavka/dostavka-calc.js", array(), "1.49");
